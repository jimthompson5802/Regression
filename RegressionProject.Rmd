...
using all the relevant variables,i.e., **`r get.formula(lm1)`**.  For this model the F-statistic is `r f[1]` with a p-value of `r pf(f[1],f[2],f[3],lower.tail=FALSE)`, which show the model is
...
a manual transmission, the mpg increases `r round(coef(lm2)[4],3)` over that from an
...
**Figure 1**
```{r ,echo=FALSE,fig.width=3.5,fig.height=3.5,fig.cap="Figure 1"}
